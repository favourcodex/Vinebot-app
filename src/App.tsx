...
import { 
  Bot, Mail, ChevronRight, User, KeyRound, 
  ArrowLeft, CheckCircle2, Sparkles, ShieldAlert
} from 'lucide-react';
            ...
            <div className="bg-[#050505] min-h-screen text-gray-200 flex flex-col items-center justify-center p-4">
              <div className="text-center space-y-4 max-w-md">
                ...
                <div className="pt-2 flex gap-3 justify-center">
                  <button onClick={() => setRoute('/dashboard')} className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-lg text-xs font-bold uppercase cursor-pointer">
                    Return to Dashboard
                  </button>
        ...
        return (
          <div className="bg-[#07090d] min-h-screen text-gray-200 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
              ...
              <div className="w-12 h-12 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mx-auto">
              ...
              <div className="bg-[#0e1118] border border-[#1b202e] py-8 px-4 shadow sm:rounded-xl sm:px-10">
                ...
                <form className="space-y-4" onSubmit={async (e) => {
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input 
                        ...
                        className="w-full bg-[#080a0e] border border-[#232a39] rounded-lg pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-purple-500"
                        required
                      />
                  ...
                  <button 
                    type="submit"
                    disabled={submitting}
                    className="w-full py-3 bg-purple-600 hover:bg-purple-500 text-white font-semibold text-xs tracking-wider rounded-lg transition uppercase flex items-center justify-center gap-1 cursor-pointer"
                  >
        ...
        return (
          <div className="bg-[#07090d] min-h-screen flex items-center justify-center p-4">
            <div className="text-center">
              ...
              <button 
                onClick={() => setRoute('/')}
                className="mt-6 px-4 py-2 bg-purple-600 text-white rounded-lg text-xs font-bold uppercase transition"
              >
                Go Home
              </button>
            </div>
