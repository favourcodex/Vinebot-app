  ...
  return (
    <div className="bg-[#050505] min-h-screen text-gray-200 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <div className="w-12 h-12 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mx-auto shadow-[0_0_15px_rgba(147,51,234,0.15)]">
          <ShieldAlert className="w-6 h-6 text-purple-400" />
        </div>
        <h2 className="mt-4 text-2xl font-bold tracking-tight text-white uppercase font-mono">Operations Console</h2>
        <p className="mt-1 text-xs text-purple-400/80 uppercase tracking-widest font-mono text-[9px]">Authorized Administrators Only</p>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#0b0c10] border border-purple-500/20 py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10 shadow-purple-950/20">
          {authError && (
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-[10px] font-semibold text-purple-400/80 uppercase tracking-wider mb-1.5 font-mono">
                Admin Email Address
              </label>
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[#080a0e] border border-purple-950/60 rounded-lg pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-purple-500 font-mono placeholder:text-gray-600"
                  required
                />
            ...
            <button 
              type="submit"
              disabled={submitting}
              className="w-full py-3 bg-purple-600 hover:bg-purple-500 active:bg-purple-700 disabled:opacity-50 text-white font-semibold text-xs tracking-wider rounded-lg transition uppercase flex items-center justify-center gap-2 cursor-pointer font-mono shadow-lg shadow-purple-600/20"
            >
              {submitting ? (
                <>
