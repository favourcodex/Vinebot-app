...
// Explicit CORS configuration strictly restricting origins to configured frontend URL
const frontendUrl = (process.env.FRONTEND_URL || process.env.CLIENT_URL || 'https://vinebot-app.vercel.app').replace(/\/$/, '');
